...
import com.example.proba.CoffeeActivity;
import com.example.proba.PizzaActivity;
import com.example.proba.R;
import com.example.proba.SushiActivity;
import com.example.proba.VeganActivity;
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (holder.getAdapterPosition() == 0){
                    ...
                    intent = new Intent(context, SushiActivity.class);
                } else if (holder.getAdapterPosition() == 3){
                    intent = new Intent(context, VeganActivity.class);
