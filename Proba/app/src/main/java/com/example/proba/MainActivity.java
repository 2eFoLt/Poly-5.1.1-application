...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foodsList.add(new food(3,"postnoe", "Постное","#424345"));
        foodsList.add(new food(4,"pancakes","Десерты","#424345"));
        foodsList.add(new food(5,"steak","Стейки","#424345"));
        foodsList.add(new food(6, "hot", "Хот-Доги","#424345"));
