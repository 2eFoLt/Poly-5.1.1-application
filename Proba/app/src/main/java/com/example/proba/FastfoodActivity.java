...
public class FastfoodActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FastFoodList.add(new FastFood(1,"fastfood1","McDonald's","#FFFFFFFF"));
        FastFoodList.add(new FastFood(2,"fastfood2","Subway","#FFFFFFFF"));
        FastFoodList.add(new FastFood(3,"fastfood3","Burger King","#FFFFFFFF"));
        FastFoodList.add(new FastFood(4,"fastfood4","KFC","#FFFFFFFF"));
        FastFoodList.add(new FastFood(5,"fastfood5","NewYork Burger","#FFFFFFFF"));
        FastFoodList.add(new FastFood(6,"fastfood6","#Farsh","#FFFFFFFF"));
